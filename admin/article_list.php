...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr id="sx">
    <td height="30" colspan="5">&nbsp;文章管理</td>
  </tr>
  <tr>
  	<td width="10%" height="33" align="center">&nbsp;文章ID</td>
  ...
  <tr>
    ...
    <td width="8%">&nbsp;<input type="submit" name="btn2" id="btn2" value="修改" onClick="window.location.href='article_modify.php?id=<?=$row['id']?>'"></td>
