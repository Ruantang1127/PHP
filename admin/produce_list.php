...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr id="sx">
    <td height="30" colspan="5">&nbsp;产品列表</td>
  </tr>
  <tr>
  	<td width="10%" height="33" align="center">&nbsp;产品ID</td>
  ...
  <tr>
    ...
    <td width="8%">&nbsp;<input type="submit" name="btn2" id="btn2" value="修改" onClick="window.location.href='produce_modify.php?id=<?=$row['id']?>'"></td>
...
<?php
	...
	if(isset($_GET['act'])=='del'){
			...
			if(mysqli_query($conn,$sql)){
				...
				echo"<script>alert('删除失败！');window.location.href='produce_list.php'</script>";
			}
	}
	mysqli_close($conn);
?>