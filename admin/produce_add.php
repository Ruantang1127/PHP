...
<table align="left" width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr id="sx">
    <td height="30" colspan="2">&nbsp;添加水果冷知识</td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="20%" height="60" align="center">&nbsp;<span style="color:#F00">*</span>内容：</td>
    <td width="80%">&nbsp;<input name="content" type="text" id="content" size="50"></td>
  </tr>
  <tr>
